...
$('.thumb-slider').slick({
    slidesToShow: 4, // Adjust this according to your layout
    slidesToScroll: 1, // Adjust this according to your layout
    arrows: true, // Adjust this according to your layout
    asNavFor: '.preview-slider' // Link the thumb-slider to the preview-slider
  });
// Initialize the slick plugin on the preview-slider element
$('.preview-slider').slick({
    slidesToShow: 1, // Adjust this according to your layout
    slidesToScroll: 1, // Adjust this according to your layout
    arrows: true, // Adjust this according to your layout
    asNavFor: '.thumb-slider' // Link the preview-slider to the thumb-slider
  });
